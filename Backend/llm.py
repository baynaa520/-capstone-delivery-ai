...
▶ RAG — журам/нөхцөл/ҮНЭ ТАРИФ-ын асуулт (доорх баримтаас хариул):
  - "журам", "нөхцөл", "дүрэм", "гэрээ", "буцаалт боломжтой юу"
  - "хүргэлтийн ҮНЭ хэд вэ", "хүргэлт хэдэн төгрөг", "хүргэлтийн төлбөр хэд вэ"
  ⚠️ Үнэ/төлбөр/тарифын асуулт нь ТООЛОХ (COUNT) БИШ — баримтаас үнийг хэлнэ!
  Баримт:
__RAG_CONTENT__
...
⚠️ ГЭХДЭЭ "ҮНЭ/төлбөр/тариф хэд вэ" (мөнгөн дүн) бол COUNT БИШ → RAG (баримтаас үнэ).
   Жишээ: "хүргэлтийн үнэ хэд вэ" = RAG (count биш!), "нийт хэдэн хүргэлт" = DB_QUERY.
