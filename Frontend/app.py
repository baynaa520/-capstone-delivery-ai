...
def show_login():
    ...
    with col2:
        # st.link_button нь жинхэнэ навигаци хийдэг. markdown доторх <a><div>...</div></a>
        # Streamlit-д заримдаа ажилладаггүй (товч дармагц URL өөрчлөгддөггүй) тул үүнийг ашиглав.
        st.link_button("🔓  Gmail-ээрээ нэвтрэх", f"{API_URL}/auth/google",
